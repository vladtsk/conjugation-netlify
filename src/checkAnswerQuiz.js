...
function checkAnswerQuiz(
  answer,
  { data, k, phraseCount, score, boxes, phraseStats, lives, userId }
) {
...
export function handleQuizAnswerSubmit({
  data,
  k,
  phraseCount,
  score,
  ...
  return new Promise((resolve, reject) => {
    ...
    if (option1 && option2 && option3 && option4) {
      ...
      function handleClick(event) {
        ...
        let quizResult = checkAnswerQuiz(answer, {
          data,
          k,
          phraseCount,
          score,
